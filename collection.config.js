...
const collection = {
  ...
  name: "Khmer Literature Character Analysis",

  // One sentence: what is this archive, and why does it matter?
  description: "The archive of Khmer literature character analysis based on different perspective from different khmer literature teachers and its relevance to modern youths, built for ICT 340.",
